    ...
    public class ComicBookRepository
    {
        private static ComicBook[] _comicBooks = new ComicBook[]
        {
            new ComicBook()
            {
                ...
                IssueNumber = 700,
                DescriptionHtml = "<p>Final issure! Witness the final hours of Doctor Octopus' life and his one, last, great act of revenge! Even if Spider-Man survives... <strong> will Peter Parker?</strong></p>",
                Artists = new Artist[]
                {
                    ...
                    new Artist() { Name = "Chris Elipoulos", Role = "Letters"},
                }
            },
            new ComicBook()
            {
